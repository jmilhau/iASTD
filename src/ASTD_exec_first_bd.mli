...
val register_db : string -> ASTD_constant.t option -> ASTD_state.t -> ASTD_astd.t -> unit
val get_db : string -> ASTD_state.t
...
val execute_event_list: int-> bool -> ASTD_state.t -> ASTD_astd.t -> ASTD_event.t list -> float-> (ASTD_state.t*float*int)
...
val print_h : ((astd_name * ASTD_state.t) list) -> ASTD_astd.t -> string -> string-> string-> unit
